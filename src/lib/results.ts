...
export const adsResults: ResultItem[] = [
  {
    ...
    metric: "164 Calls",
    description: "Massive spike in call volume from a single day of optimized Google Ads — 21,204 impressions at just £1.20 avg CPC.",
  ...
  },
  {
    ...
    metric: "89 Calls",
    description: "High-efficiency call campaign delivering 89 qualified phone calls at £0.52 avg CPC across 26 days.",
  ...
  },
  {
    ...
    metric: "71 Calls / £345",
    description: "Performance Max + smart bidding delivered 71 calls in a single week at predictable cost per lead.",
  ...
  },
  {
    ...
    metric: "28 Calls / £30",
    description: "Ultra-low spend campaign tuned for maximum call conversions — every pound producing measurable leads.",
  ...
  },
  {
    ...
    metric: "22 Calls",
    description: "Geo-targeted call-only campaign converting at outstanding efficiency for a local service business.",
  ...
  },
  {
    ...
    metric: "18 Calls / £88",
    description: "Optimized search campaign producing 18 high-intent phone calls at industry-leading cost per call.",
  ...
  },
  {
    ...
    description: "Every single click converted into a phone call — landing experience + call extensions firing perfectly.",
  ...
  },
  {
    ...
    metric: "13 Calls / £14",
    description: "Razor-sharp call-only campaign — full click-to-call conversion at under £1.15 per qualified lead.",
