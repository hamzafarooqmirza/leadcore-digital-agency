...
export function GoogleAdsMark({ className }: IconProps) {
  return (
    <svg viewBox="0 0 48 48" className={className} aria-hidden>
      ...
      <path
        fill="#4285F4"
        d="M28.2 14.5a4 4 0 0 1 5.46-1.47l7.5 4.33a4 4 0 0 1 1.47 5.46l-13.3 23a4 4 0 0 1-6.93-4z"
      />
...
export function GoogleBusinessMark({ className }: IconProps) {
  return (
    <svg viewBox="0 0 48 48" className={className} aria-hidden>
      <path
        fill="#4285F4"
        d="M24 4c-7.5 0-13.5 6-13.5 13.5C10.5 30 24 44 24 44s13.5-14 13.5-26.5C37.5 10 31.5 4 24 4z"
      />
...
export function FacebookMark({ className }: IconProps) {
  return (
    <svg viewBox="0 0 48 48" className={className} aria-hidden>
      <path
        fill="#1877F2"
        d="M44 24c0-11-9-20-20-20S4 13 4 24c0 10 7.3 18.2 16.8 19.8V29.8H15.8V24h5V19.5c0-5 3-7.7 7.5-7.7 2.2 0 4.5.4 4.5.4v5h-2.5c-2.5 0-3.3 1.5-3.3 3.1V24h5.6l-.9 5.8h-4.7V43.8C36.7 42.2 44 34 44 24z"
      />
    </svg>
  );
}
...
export const serviceBrand: Record<string, Brand> = {
  ...
  "google-my-business-optimization": {
    ...
    tint: "from-[#4285F4]/15 to-[#34A853]/15",
  },
  "website-design-development": {
    Mark: (p) => <MonitorSmartphone {...p} />,
    tint: "from-gold/15 to-[#4285F4]/10",
  },
  ...
  "google-conversion-tracking": {
    Mark: (p) => <LineChart {...p} />,
    tint: "from-[#4285F4]/15 to-[#FBBC04]/10",
  },
  "performance-max-campaigns": {
    Mark: PerformanceMaxMark,
    tint: "from-[#4285F4]/15 to-[#EA4335]/10",
  },
  "shopping-ads-management": {
    Mark: GoogleShoppingMark,
    tint: "from-[#FBBC04]/20 to-[#34A853]/10",
  },
  "lead-generation-campaigns": { Mark: (p) => <Users {...p} />, tint: "from-gold/20 to-gold/5" },
  "call-generation-campaigns": {
    Mark: (p) => <PhoneCall {...p} />,
    tint: "from-[#34A853]/20 to-gold/10",
  },
  "google-ads-suspended-account-recovery": {
    Mark: (p) => <ShieldCheck {...p} />,
    tint: "from-[#EA4335]/15 to-gold/10",
  },
};
