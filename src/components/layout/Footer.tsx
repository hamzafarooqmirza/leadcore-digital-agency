      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 py-14 grid gap-10 lg:grid-cols-4">
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground max-w-xs">
            {site.tagline}. We help businesses generate more leads, calls and sales with data-driven
            marketing.
          </p>
          <div className="flex gap-3 pt-2">
            {[Facebook, Instagram, Linkedin, Youtube].map((Icon, i) => (
              <a
                ...
                href="#"
                aria-label="social"
                className="h-9 w-9 rounded-full border border-border flex items-center justify-center hover:border-gold hover:text-gold transition"
              >
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-muted-foreground">
            ...
            <li className="flex items-start gap-3">
              <MapPin className="h-4 w-4 mt-0.5 text-gold" /> {site.location}
            </li>
          </ul>
        </div>
      </div>
