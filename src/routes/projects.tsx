  ...
  head: () => ({
    meta: [
      { title: "Projects & Client Case Studies | LeadCore Digital" },
      {
        name: "description",
        content:
          "Explore LeadCore Digital's portfolio — Google Ads, PPC, Lead Generation and Performance Max case studies with real client results and metrics.",
      },
      { property: "og:title", content: "Projects | LeadCore Digital" },
      {
        property: "og:description",
        content:
          "Premium portfolio of digital marketing projects delivering measurable results for international clients.",
      },
      ...
      <section className="container mx-auto max-w-7xl px-4 sm:px-6 pb-20">
        <div className="mb-8">
          ...
          <h2 className="mt-3 font-display text-3xl sm:text-4xl font-bold">
            Additional Google Ads Results
          </h2>
          <p className="mt-3 text-muted-foreground max-w-2xl">
            More campaign screenshots from live client accounts — calls generated, cost per lead and
            campaign efficiency.
          </p>
        </div>
