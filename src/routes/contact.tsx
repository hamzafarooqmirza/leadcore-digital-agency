  ...
  head: () => ({
    meta: [
      { title: "Contact LeadCore Digital — Book Your Free Consultation" },
      {
        name: "description",
        content:
          "Get in touch with LeadCore Digital. WhatsApp +92 333 5858774, email leadcoredigitalpk@gmail.com. Book your free digital marketing consultation today.",
      },
        ...
        <div>
          ...
          <div className="mt-10 space-y-4">
            ...
            <ContactRow
              ...
              value="Mon–Sat · 9:00 AM – 8:00 PM (PKT)"
            />
          </div>
        </div>
        ...
        <form onSubmit={onSubmit} className="card-elevated rounded-3xl p-7 lg:p-8 space-y-4 h-fit">
          ...
          {sent && (
            <p className="text-xs text-emerald-400 text-center">
              Redirecting to WhatsApp — see you there.
            </p>
          )}
        </form>
      </section>
...
function ContactRow({
  ...
  const content = (
    <div className="flex items-start gap-4 rounded-2xl border border-border bg-surface p-4 hover:border-gold/50 transition">
      <div className="h-10 w-10 rounded-xl bg-gold/10 border border-gold/20 flex items-center justify-center text-gold">
        <I className="h-5 w-5" />
      </div>
      <div>
