  ...
  head: () => ({
    meta: [
      { title: "Industries We Serve | LeadCore Digital" },
      {
        name: "description",
        content:
          "We help cleaning companies, car recovery, real estate, AC repair, auto repair, e-commerce, healthcare and more grow with digital marketing.",
      },
      { property: "og:title", content: "Industries We Serve" },
      {
        property: "og:description",
        content: "Digital marketing specialists across high-intent service verticals.",
      },
      ...
      <section className="container mx-auto max-w-7xl px-4 sm:px-6 pb-20">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {industries.map((ind) => (
            <div
              key={ind}
              className="card-elevated rounded-2xl p-6 hover:border-gold/60 transition"
            >
