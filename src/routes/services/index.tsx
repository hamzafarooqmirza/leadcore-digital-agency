  ...
  head: () => ({
    meta: [
      { title: "Digital Marketing Services — Google Ads, SEO & More | LeadCore Digital" },
      {
        name: "description",
        content:
          "Explore our digital marketing services: Google Ads, SEO, web design, Facebook & Instagram ads, lead generation, PPC and conversion tracking.",
      },
      { property: "og:title", content: "Services — LeadCore Digital" },
      {
        property: "og:description",
        content: "End-to-end digital marketing services built to drive measurable growth.",
      },
    ...
    <SiteShell>
      <section className="container mx-auto max-w-7xl px-4 sm:px-6 pt-20 pb-10">
        ...
        <p className="mt-5 text-lg text-muted-foreground max-w-2xl">
          From paid ads to SEO to high-converting websites — pick the engine you need or combine
          them for compounding results.
        </p>
      </section>
